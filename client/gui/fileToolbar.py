...
class FileToolbar(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.newButton.setIcon(QIcon('../static/newFile.png'))
        ...
        self.exportButton.setIcon(QIcon('../static/exportFile.png'))
        ...
        self.saveButton.setIcon(QIcon('../static/saveFile.png'))
        ...
        self.cloudSaveButton.setIcon(QIcon('../static/cloudSaveFile.png'))
        ...
        self.openButton.setIcon(QIcon('../static/openFile.png'))
        ...
        self.redoButton.setIcon(QIcon('../static/redo.png'))
        ...
        self.resizeButton.setIcon(QIcon('../static/resizeFile.png'))
